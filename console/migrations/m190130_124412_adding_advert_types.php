...
/**
 * Class m190130_124412_adding_advert_types
 */
class m190130_124412_adding_advert_types extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        /// Empty the db
        Yii::$app->db->createCommand()->truncateTable('advert_types')->execute();
    ...
    {
        echo "m190130_124412_adding_advert_types cannot be reverted.\n";
        return false;
    }
}
