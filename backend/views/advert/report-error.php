    ...
    <div style="margin:auto; width:794px; height:1122px;">
        ...
        <div style="width:100%; overflow: hidden; font-size: 10pt">
            <div style="width: 50%; float: left">
                <img style="width: 100%" src="<?= Url::to('@web/css/images/renesalis_logo.png'); ?>">
            </div>
            <div style="width: 50%; float: left; text-align: center">
                <div>&nbsp;</div>
                <div>&nbsp;</div>
                <div><b>la la la - www.zaposljavanje.ba</b></div>
        ...
        <div style="width:100%; overflow: hidden; font-size: 10pt; border: 1px solid black;">
            ...
            <div style="width:24%; float: right; padding: 5px;">
                ...
                <div style="width:100%;"><?= round($advert->price * 0.83, 2); ?></div>
                <div style="width:100%;"><?= round($advert->price * 0.17, 2); ?></div>
            </div>
        </div>
        ...
        <div style="width:100%; overflow: hidden; font-size: 8pt;">
            ...
            <div style="width:40%; float: left">
                <img style="width: 100%" src="<?= Url::to('@web/css/images/stembilj.jpg'); ?>">
            </div>
        </div>
