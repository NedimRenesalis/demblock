    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                Za pravna lica koja nisu fiskalni rezident u BiH vrijedi cijenovnik na engleskom jeziku kao i maska za objavu oglasa na engleskom jeziku.</u></a>
                </div>
        </div>
    </div>
</div>
...
<br><b>Anonimni oglas</b>
                  <br>U slučaju da poslodavac ne želi navesti svoj identitet u oglasu, postoji
                    ...
                    oglas je moguć kao dodatna opcija za sve tri vrste gorenavedenih oglasa.</p>
                <p class="text-center">
                    <br>Iznos doplate je 80 KM (+ PDV 17% = 93,6KM)</p>
            </div>
        </div>
    </div>
</div>
<div class="section section-success">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a class="active btn btn-block btn-primary" href="<?= Url::to('objava-oglasa'); ?>">Nastavite dalje sa unosom detalja za oglas</a>
            </div>
        </div>
    </div>
</div>
