    ...
    <div class="normal">
        ...
        <div class="advert-body">
            ...
            <div class="number-of-positions col-lg-3 col-md-6">
                ...
                <br>
                <div>
                    <div data-id="<?= $model->id; ?>" class="btn  btn-success display-description">Show description
                    </div>
    ...
    <div class="platinum-premium">
        ...
        <div class="advert-body">
            ...
            <div class="number-of-positions col-lg-3 col-md-6">
                ...
                <br>
                <div>
                    <div data-id="<?= $model->id; ?>" class="btn  btn-info display-description">Show description
                    </div>
                    <a target="_blank" href="<?= Url::to(['oglas', "id" => $model->id]); ?>"
                       class="active btn btn-info">
                        Job</a>
