...
<div class="section">
    <div class="container">
        <div id="pik-pay-messages"> <?php foreach (Yii::$app->session->getAllFlashes() as $key => $message) { echo '<div class="alert alert-' . $key . '">' . $message . '</div>'; } ?>  </div>
                    <code>Narudžba: <?php echo $order->order_info; ?></code>
                    ...
                    <form id="pikpay-form" method="post" action=""> 
                        <div class="row">
                            ...
                            <!-- <div id="card-instructions">
                                ...
                                <br>
                                <button style="font-size: 18px" type="submit" class="btn btn-success form-control">Plati <?php echo $order->amount ?> KM</b></button>
                                <div style="text-align: center; margin-top: 15px;">
                                    ...
                                    <small>PikPay - Sigurno plaćanje</small>
                                </div>
                            </div>
