        ...
        <div class="row">
            ...
            <div class="normal">
                ...
                <div class="advert-body">
                    ...
                    <?php else: ?>
                        <div class="company col-lg-1.5 col-md-6">
                            <div><b>Unternehmensprofil:&nbsp</b><a target="_blank"
                    ...
                    <div class="category col-lg-1.5 col-md-6">
                        <div><b>Berufsfeld:</b>&nbsp<?= $model->category; ?></div>
                    </div>

                    <div class="position col-lg-1.5 col-md-6">
                        <div><b>Jobtitel:</b>&nbsp<?= $model->position; ?></div>
                    </div>
                    <br>
                    <div class="number-of-positions col-lg-1.5 col-md-6">
                        <div><b>Ort, Region:</b>&nbsp<?= $model->location; ?></div>
                    </div>
                    <br>
                    <br>
                        ...
                        <div>
                            ...
                            <?php if ($employee): ?>
                                <div class="btn  btn-info btn-warning btn-applied" <?php if (!$apply) echo 'style="display:none"'; ?>
                                     data-applied-id="<?= $model->id; ?>">Bewerbung bereits abgeschickt
                                </div>
            ...
            <div class="advert-body">
                ...
                <div class="number-of-positions col-lg-1.5 col-md-6">
                    <div>
                        ...
                        <?php else: ?>
                            <div class="btn  btn-success btn-apply-disabled">Bewerbung abschicken</div>
                        <?php endif; ?>
                    </div>
...
<div class="not-registered-wrapper advert-application" style="display: none">
    <div class="not-registered">
        ...
        Um sich zu bewerben, melden Sie sich bitte zuerst an:<br>
        <a href="<?= Url::to(['prijava']); ?>">ANMELDUNG</a><br><br>
        Wenn Sie noch kein Profil haben:<br>
        <a href="<?= Url::to(['registracija-posloprimac']); ?>">REGISTRIERUNG ARBEITNEHMER</a>
    </div>
</div>
