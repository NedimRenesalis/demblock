...
if ($banners) {
    ...
    foreach ($banners as $banner) {
        ...
        ['//visit', 'id' => $banner->slug], ['class' => 'banner col-md-6 col-sm-12 col-lg-6', 'target' => '_blank']);
    }
    ...
    if((array)$centeredBanner) {
        ...
        ['//visit', 'id' => $centeredBanner->slug], ['class' => 'banner col-md-6 col-md-offset-3 col-sm-12 col-lg-6 col-lg-offset-3', 'target' => '_blank']);
