    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <?= $form->field($searchModel, 'location')->label("City or Country") ?>
            </div>

            <div class="col-lg-3 col-md-6">
                <?= $form->field($searchModel, 'position')->label("Position or Company") ?>
            </div>

            <div class="col-lg-3 col-md-6">
                <?= $form->field($searchModel, 'category')->dropDownList($jobs, ['prompt' => 'Choose category'])->label('Category') ?>
            </div>
