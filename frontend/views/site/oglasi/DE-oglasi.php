    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <?= $form->field($searchModel, 'location')->label("Stadt oder Land") ?>
            </div>

            <div class="col-lg-3 col-md-6">
                <?= $form->field($searchModel, 'position')->label("Position oder Firmenname") ?>
            </div>

            <div class="col-lg-3 col-md-6">
                <?= $form->field($searchModel, 'category')->dropDownList($jobs, ['prompt' => 'Kategorie auswählen'])->label('Kategorie') ?>
            </div>

            <div class="form-group col-lg-3 col-md-6 search-button">
                <?= Html::submitButton('Suchen', ['class' => 'btn btn-success']) ?>
            </div>
